...
public interface IPlayerContext {
    ...
    default BetterBlockPos playerFeet() {
        BetterBlockPos feet = new BetterBlockPos(mob().position().x, mob().position().y + 0.1251, mob().position().z);
    ...
    default Vec3 playerFeetAsVec() {
        return new Vec3(mob().position().x, mob().position().y, mob().position().z);
    }

    default Vec3 playerHead() {
        return new Vec3(mob().position().x, mob().position().y + mob().getEyeHeight(), mob().position().z);
    }

    default Rotation playerRotations() {
        return new Rotation(mob().getYRot(), mob().getXRot());
    }
