...
//     * @see #reachable(ServerPlayer, BlockPos, double)
    ...
    public static Optional<Rotation> reachable(IPlayerContext ctx, BlockPos pos) {
        return reachable(ctx.mob(), pos, ctx.playerController().getBlockReachDistance());
    }

    public static Optional<Rotation> reachable(IPlayerContext ctx, BlockPos pos, boolean wouldSneak) {
        return reachable(ctx.mob(), pos, ctx.playerController().getBlockReachDistance(), wouldSneak);
    }
     ...
     * @return The optional rotation
     */
    public static Optional<Rotation> reachable(PathfinderMob entity, BlockPos pos, double blockReachDistance) {
        return reachable(entity, pos, blockReachDistance, false);
    }

    public static Optional<Rotation> reachable(PathfinderMob entity, BlockPos pos, double blockReachDistance, boolean wouldSneak) {
        IBaritone baritone = BaritoneAPI.getBaritoneForPlayer(entity);
