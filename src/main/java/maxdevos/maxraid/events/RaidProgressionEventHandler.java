...
//        new ExplodingPhantom(raid, new BlockVector(-460, 121, 617));
//        new RaidGoat(raid, new BlockVector(-460, 121, 617));
//    }
    ...
    private class GroundTroops {
        ...
        public void spawn(){
            ...
            for(int i = 0; i < suicidePhantoms; i++){
                new ExplodingPhantom(raid, getRandomSpawn().add(new BlockVector(0, 30, 0)).toBlockVector());
            }
            ...
            for(int i = 0; i < skel; i++){
                new RaidSkeleton(raid, getRandomSpawn(), (float) (20 * (wave * 1.3)));
            }
    ...
    private class Fleet {
        ...
        public void spawn(){
            ...
            for(int i = 0; i < fullAuto; i++) {
                fleet.addMobToFleet(new FullAutoSkeleton(raid, 20* (wave * 1.5)));
            }
