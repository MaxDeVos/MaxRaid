...
public class RaidProgressionEventHandler implements Listener {
    ...
    public void newRaidWave(RaidSpawnWaveEvent waveEvent){
        ...
        if(wave == 2){
            ...
            Fleet f1 = new Fleet(new BlockVector(-472, 120, 594));
            f1.fuseless = 1;
            f1.fullAuto = 1;
            f1.endermen = 0;
            f1.pillager = 0;
        ...
        if(wave == 3){
            ...
            ParatrooperDroppingPhantom paraDropper = new ParatrooperDroppingPhantom(raid,
                    new BlockVector(raid.raidBase.zeroCorner.getX() - 20, 120, 593));
            Fleet f1 = new Fleet(new BlockVector(-492, 120, 586));
            f1.fuseless = 2;
            f1.fullAuto = 3;
            f1.endermen = 0;
            f1.pillager = 0;
        ...
        if(wave == 4){
            ...
            ParatrooperDroppingPhantom paraDropper = new ParatrooperDroppingPhantom(raid,
                    new BlockVector(raid.raidBase.zeroCorner.getX() - 20, 120, 593));
            Fleet f1 = new Fleet(new BlockVector(-484, 120, 576));
            f1.fuseless = 4;
            f1.fullAuto = 4;
            f1.endermen = 0;
            f1.pillager = 0;
            ...
            Fleet f2 = new Fleet(new BlockVector(-481, 120, 602));
            f2.fuseless = 4;
            f2.fullAuto = 4;
            f2.endermen = 0;
            f2.pillager = 0;
        ...
        if(wave == 5){
            ...
            Fleet f2 = new Fleet(new BlockVector(-453, 120, 599));
            f2.fuseless = 4;
            f2.fullAuto = 5;
            f2.endermen = 1;
            f2.pillager = 2;
        ...
        if(wave == 6){
            ...
            Fleet f2 = new Fleet(new BlockVector(-453, 120, 592));
            f2.fuseless = 4;
            f2.fullAuto = 5;
            f2.endermen = 1;
            f2.pillager = 2;
        ...
        if(wave == 7){
            ...
            ParatrooperDroppingPhantom paraDropper = new ParatrooperDroppingPhantom(raid,
                    new BlockVector(raid.raidBase.zeroCorner.getX() - 20, 120, 593));
            Fleet f1 = new Fleet(new BlockVector(-475, 120, 588));
            f1.fuseless = 4;
            f1.fullAuto = 4;
            f1.endermen = 1;
            f1.pillager = 1;
            ...
            Fleet f2 = new Fleet(new BlockVector(-476, 120, 602));
            f2.fuseless = 4;
            f2.fullAuto = 5;
            f2.endermen = 1;
            f2.pillager = 2;
            ...
            ParatrooperDroppingPhantom paraDropper2 = new ParatrooperDroppingPhantom(raid,
                    new BlockVector(raid.raidBase.zeroCorner.getX() - 20, 120, 593));
            f1 = new Fleet(new BlockVector(-475, 120, 588));
            f1.fuseless = 4;
            f1.fullAuto = 4;
            f1.endermen = 1;
            f1.pillager = 1;
            ...
            f2 = new Fleet(new BlockVector(-476, 120, 602));
            f2.fuseless = 4;
            f2.fullAuto = 5;
            f2.endermen = 1;
            f2.pillager = 2;
    ...
    private class GroundTroops {
        ...
        public void spawn(){
            ...
            for(int i = 0; i < zombies; i++){
                new RaidZombie(raid, getRandomSpawn(), 20f, Color.WHITE, null);
            }

            for(int i = 0; i < witherSkels; i++){
                new RaidWitherSkeleton(raid, getRandomSpawn(), 20f,Color.WHITE, null);
            }
            ...
            for(int i = 0; i < skel; i++){
                new RaidSkeleton(raid, getRandomSpawn(), 20 * (wave * 1.2));
            }
